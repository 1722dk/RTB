...
import com.datacontext.JdbcConnection
import com.protocol.utility.UserInput
import com.server.{HttpServerWithActorInteraction, Webserver, Webserver2}
...
object Program {
  def main(args: Array[String]): Unit = {
    ...
    //Webserver.testHttp();
    //Webserver2.testHttp2();
    //HttpServerWithActorInteraction.auctionTest();
    /*var counter = 0
    do {
